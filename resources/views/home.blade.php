...
<div class="container">
    <div class="row">
        <div class="col-md-9" style="text-align:center; margin-top: 20vh;">
            ...
            <h4 style="font-family: 'Gotu', sans-serif; margin-top:12vh"><span class="text-primary">◦ </span><span class="typed-words"></span></h4><br><br>
            @guest
